...
import com.hosinc.shopperapp.shopper.app.methods.Methods;
import com.hosinc.shopperapp.shopper.app.methods.UserDetails;
...
public class UsGetStarted extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.us_get_started);
        ...
        UsersDetailsRef = db.collection(ShopperContract.USER_DETAILS);
    ...
    private void openGallery() {
        if (methods.checkIfAlreadyHavePermission()) {
            ActivityCompat.requestPermissions(UsGetStarted.this, new String[]{Manifest.permission
        ...
        if (imageUri != null) {
            imageRef.putFile(imageUri).addOnProgressListener(taskSnapshot -> {
                ...
                if (task.isSuccessful()) {
                    ...
                    Intent i = new Intent(UsGetStarted.this, HomeNavigation.class);
                    startActivity(i);
                    finish();
                } else {
    ...
    private void openCalendar() {
        datePickerDialog = new DatePickerDialog(this, R.style.DialogSheetTheme, (view, year, month, day) -> {
            ...
            InputMethodManager imm = (InputMethodManager) UsGetStarted.this.getSystemService(Context.INPUT_METHOD_SERVICE);
            if (imm != null) {
